...
<service>
  ...
  <name>valimart harness 公司网关</name>
  <description>valimart harness 企业交付工作台的公司网关：公司账号与网关令牌、模型代理与按人记账、任务验收流、公司盘。</description>
  ...
  <env name="DESK_GATEWAY_PACKAGED" value="1"/>
