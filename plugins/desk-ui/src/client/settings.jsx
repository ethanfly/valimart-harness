...
import { clientVersionDetail, clientVersionLabel, kernelVersionLabel, searchKeyLabel } from './version.js'
  ...
  const versionCard = (
    <div className="dk-card">
      ...
      <div className="dk-kv">
        ...
        <div><div className="k">搜索密钥</div><div className="v">{searchKeyLabel(desk)}</div></div>
